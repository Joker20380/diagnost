...
- [x] нормализовать справочники марки и модели автомобиля:
  - [x] модель автомобиля связана с одной маркой;
  - [x] автомобиль связан с маркой и моделью внешними ключами;
  - [x] существующие текстовые марки и модели переносятся миграцией;
  - [x] новые подтверждения VIN переиспользуют справочник без дубликатов;
  - [x] старые текстовые поля сохранены как совместимый снимок;
